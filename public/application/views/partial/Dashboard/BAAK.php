              ...
              <div class="clearfix">
                ...
                <div class="float-right">
                  ...
                  <div class="fluid-container">
                    <h3 class="font-weight-medium text-right mb-0"><?=$baak_total_izincuti;?></h3>
                  </div>
                </div>
              </div>
            ...
            <div class="card-body">
              <div class="clearfix">
                ...
                <div class="float-right">
                  ...
                  <div class="fluid-container">
                    <h3 class="font-weight-medium text-right mb-0"><?=$baak_total_izinsekolah;?></h3>
                  </div>
                </div>
              </div>
              <p class="text-muted mt-3 mb-0">
            ...
            <div class="card-body">
              <div class="clearfix">
                ...
                <div class="float-right">
                  ...
                  <div class="fluid-container">
                    <h3 class="font-weight-medium text-right mb-0"><?=$baak_total_izinseminar;?></h3>
                  </div>
                </div>
              </div>
              <p class="text-muted mt-3 mb-0">
            ...
            <div class="card-body">
              <div class="clearfix">
                ...
                <div class="float-right">
                  ...
                  <div class="fluid-container">
                    <h3 class="font-weight-medium text-right mb-0"><?=$baak_izin_terkonfirmasi;?></h3>
                  </div>
                </div>
              </div>
              <p class="text-muted mt-3 mb-0">
